...
const [selectedTechnologies, setSelectedTechnologies] = useState<ITechnology[]>([]);
    return (
        ...
        <div className="grid grid-cols-1   gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  ">
            <div className="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-3  flex"> 
            ...
            <div className="md:col-span-1  flex justify-center md:block md:mt-12 mb-12  md:mb-0"> 
